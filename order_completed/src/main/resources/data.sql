...
-- 1분 단위
CREATE MATERIALIZED VIEW BTCKRW_m1_trades WITH (timescaledb.continuous) AS
SELECT
...
-- 3분 단위
CREATE MATERIALIZED VIEW BTCKRW_m3_trades WITH (timescaledb.continuous) AS
SELECT
...
-- 5분 단위
CREATE MATERIALIZED VIEW BTCKRW_m5_trades WITH (timescaledb.continuous) AS
SELECT
...
-- 15분 단위
CREATE MATERIALIZED VIEW BTCKRW_m15_trades WITH (timescaledb.continuous) AS
SELECT
...
-- 30분 단위
CREATE MATERIALIZED VIEW BTCKRW_m30_trades WITH (timescaledb.continuous) AS
SELECT
...
-- 1시간 단위
CREATE MATERIALIZED VIEW BTCKRW_h1_trades WITH (timescaledb.continuous) AS
SELECT
...
-- 3시간 단위
CREATE MATERIALIZED VIEW BTCKRW_h3_trades WITH (timescaledb.continuous) AS
SELECT
...
-- 6시간 단위
CREATE MATERIALIZED VIEW BTCKRW_h6_trades WITH (timescaledb.continuous) AS
SELECT
...
-- 12시간 단위
CREATE MATERIALIZED VIEW BTCKRW_h12_trades WITH (timescaledb.continuous) AS
SELECT
...
-- 1일 단위
CREATE MATERIALIZED VIEW BTCKRW_d1_trades WITH (timescaledb.continuous) AS
SELECT
...
-- 1주일 단위
CREATE MATERIALIZED VIEW BTCKRW_w1_trades WITH (timescaledb.continuous) AS
SELECT
...
-- 1달 단위
CREATE MATERIALIZED VIEW BTCKRW_mon1_trades WITH (timescaledb.continuous) AS
SELECT
