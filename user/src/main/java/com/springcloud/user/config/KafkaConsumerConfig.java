...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, KafkaUserBalanceIncreaseEvent> consumerFactory() {
        ...
        configProps.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, KafkaUserBalanceIncreaseEvent.class);
...
//     이 팩토리는 @KafkaListener 어노테이션이 붙은 메서드들을 실행할 컨테이너를 제공합니다.
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, KafkaUserBalanceIncreaseEvent> kafkaListenerContainerFactory(/*ConsumerFactory<String, IdentityIntegrationCommand> consumerFactory*/) {
